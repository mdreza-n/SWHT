...
flush();
$API_KEY = '533690422:AAE83L4IWD5Uxdjg4DqMlOaoobtj8a7i0MQ';  // توکن رباتتون رو جاگذاری کنید
...
$ADMIN = "328335003"; // شناسه ادمین را جاگذاری کنید
...
//====================(@SWHT)======================//
elseif($text == '/creator'){
SendMessage($chat_id,"Created By: @SWHTBot","html","true");
}
